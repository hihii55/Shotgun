package com.thebkkingdom.Shotgun.commands;
...
import com.thebkkingdom.Shotgun.ShotgunConfiguration;
...
public class ShotgunCommands implements CommandExecutor {
	...
	public static void registerCommands() {
		Shotgun.getInstance().getCommand("s")
				.setExecutor(new ShotgunCommands());
	}
}
